...
test: src/lexical-analyser.test.c src/states-machine.test.c src/lexical-analyser.c src/states-machine.c src/token.c
	...
	@gcc -o dist/code-generator.test src/code-generator/code-generator.test.c src/code-generator/code-generator.c src/code-generator/code-generator-transition.c src/syntatic-analyser.c src/create_ape.c src/ape.c src/lexical-analyser.c src/token.c src/states-machine.c -I.
